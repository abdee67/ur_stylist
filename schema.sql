...
CREATE OR REPLACE FUNCTION "public"."credit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text" DEFAULT 'etb'::"text", "p_source" "text" DEFAULT 'booking_earning'::"text", "p_reference" "text" DEFAULT NULL::"text", "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."credit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."debit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid" DEFAULT NULL::"uuid", "p_payment_id" "uuid" DEFAULT NULL::"uuid", "p_amount" numeric DEFAULT 0, "p_currency" "text" DEFAULT 'etb'::"text", "p_source" "text" DEFAULT 'penalty'::"text", "p_reference" "text" DEFAULT NULL::"text", "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
CREATE TABLE IF NOT EXISTS "public"."payouts" (
    ...
    CONSTRAINT "payouts_method_check" CHECK (("payout_method" = ANY (ARRAY['bank_transfer'::"text", 'paypal'::"text", 'stripe'::"text"]))),
    CONSTRAINT "payouts_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'processing'::"text", 'paid'::"text", 'cancelled'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."wallet_transactions" (
    ...
    CONSTRAINT "wallet_transactions_source_check" CHECK (("source" = ANY (ARRAY['booking_earning'::"text", 'penalty'::"text", 'withdrawal'::"text", 'topup'::"text"]))),
    CONSTRAINT "wallet_transactions_type_check" CHECK (("transaction_type" = ANY (ARRAY['credit'::"text", 'debit'::"text"])))
);
...
ALTER TABLE ONLY "public"."wallets"
    ADD CONSTRAINT "wallets_stylist_id_key" UNIQUE ("stylist_id");
...
CREATE INDEX "idx_payouts_wallet_id" ON "public"."payouts" USING "btree" ("wallet_id");
...
CREATE UNIQUE INDEX "idx_wallet_transactions_booking_earning_unique" ON "public"."wallet_transactions" USING "btree" ("wallet_id", "booking_id", "source", "transaction_type") WHERE (("booking_id" IS NOT NULL) AND ("source" = 'booking_earning'::"text") AND ("transaction_type" = 'credit'::"text"));
...
CREATE INDEX "idx_wallet_transactions_source" ON "public"."wallet_transactions" USING "btree" ("source");
...
CREATE INDEX "idx_wallets_stylist_id" ON "public"."wallets" USING "btree" ("stylist_id");
...
CREATE OR REPLACE TRIGGER "trg_payouts_set_updated_at" BEFORE UPDATE ON "public"."payouts" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "trg_wallets_set_updated_at" BEFORE UPDATE ON "public"."wallets" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();
...
ALTER TABLE ONLY "public"."wallets"
    ADD CONSTRAINT "wallets_stylist_id_fkey" FOREIGN KEY ("stylist_id") REFERENCES "public"."stylists"("id") ON DELETE CASCADE;
...
CREATE POLICY "payouts_select_own" ON "public"."payouts" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."wallets" "w"
  WHERE (("w"."id" = "payouts"."wallet_id") AND ("w"."stylist_id" = "auth"."uid"())))));
...
CREATE POLICY "wallet_transactions_select_own" ON "public"."wallet_transactions" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."wallets" "w"
  WHERE (("w"."id" = "wallet_transactions"."wallet_id") AND ("w"."stylist_id" = "auth"."uid"())))));
...
CREATE POLICY "wallets_select_own" ON "public"."wallets" FOR SELECT TO "authenticated" USING (("stylist_id" = "auth"."uid"()));
...
REVOKE ALL ON FUNCTION "public"."credit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."credit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."credit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."credit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") TO "service_role";



REVOKE ALL ON FUNCTION "public"."debit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."debit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."debit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."debit_stylist_wallet"("p_stylist_id" "uuid", "p_booking_id" "uuid", "p_payment_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_source" "text", "p_reference" "text", "p_metadata" "jsonb") TO "service_role";
